...
namespace DefaultNamespace
{
    ...
    public class ReplayMover : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            // ИНИЦИАЛИЗИРУЕМ _prev ПЕРВОЙ ЗАПИСЬЮ
            _prev = _save.Records[0];
            _index = 1; // начинаем со второй записи
            Debug.Log($"ReplayMover started with {_save.Records.Count} records");
        }

        private void Update()
        {
            // Если все записи пройдены - выходим
